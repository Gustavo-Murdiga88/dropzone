import { CheckCircle, DownloadSimple, Monitor, XCircle, FilePdf, ThumbsDown } from "phosphor-react";
...
export function File({ title, url = img, onRemove, loaded, type, sizeOut}: FileProps) {
  return (
    <div
      id='line'
      onClick={(e) => {
    ...
    >
      ...
      >
        {
        !sizeOut ? <ThumbsDown  size={24} color='#E53E3E'/> : 
        loaded ? 
